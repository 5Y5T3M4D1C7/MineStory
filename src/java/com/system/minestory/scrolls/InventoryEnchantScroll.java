...
public class InventoryEnchantScroll implements IInventory, IItemHandler{
    private final NonNullList<ItemStack> stackList;
    private final Container eventHandler;

    public InventoryEnchantScroll(Container eventHandlerIn)
    {
    ...
    {
        return "container.enchant_scroll";
    }
